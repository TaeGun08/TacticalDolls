    ...
    public class UvRegionEditor : EditorWindow
    {
        ...
        private void HandleResize()
        {
            for (int i = 0; i < resizeHandles.Length; i++)
            {
                ...
                var fmh_1520_73_638852495635259080 = Quaternion.identity; Vector3 newHandlePosition = Handles.FreeMoveHandle(pos, 10f, Vector2.zero, Handles.RectangleHandleCap);
                if (EditorGUI.EndChangeCheck())
                {
