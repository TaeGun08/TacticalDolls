...
[CustomPropertyDrawer(typeof(CustomBezierCurveTweenBehaviour))]
public class CustomBezierCurveTweenDrawer : PropertyDrawer
{
    ...
    {
        int fieldCount = property.FindPropertyRelative ("tweenType").enumValueIndex == (int)CustomBezierCurveTweenBehaviour.TweenType.Custom ? 5 : 3;
    ...
    public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (tweenTypeProp.enumValueIndex == (int)CustomBezierCurveTweenBehaviour.TweenType.Custom)
        {
